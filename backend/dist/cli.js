...
program
    ...
    .version('1.0.0');
program.command("greet <name>").action((name) => { console.log(`Hello ${name}`); });
program.command("add <n1> <n2>").description("Add two numbers").action((n1, n2) => { console.log(Number(n1) + Number(n2)); });
program.command("sub <n1> <n2>").description("Subtract second number from first number").action((n1, n2) => { console.log(Number(n1) - Number(n2)); });
program.command("mul <n1> <n2>").description("Multiply two numbers").action((n1, n2) => { console.log(Number(n1) * Number(n2)); });
program.command("div <n1> <n2>").description("Divide first numbers by second number").action((n1, n2) => { console.log(Number(n1) / Number(n2)); });
program
    .command("joke")
